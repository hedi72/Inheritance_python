class Animal:
    def __init__(self, birthType="unknoun", appearance="unknoun", blooded="unknoun"):
...
class Mammal(Animal):
    def __init__(self, birthType="born live2", appearance="hair or fur", blooded="warn blooded", nurseYoung=True):
...
class Reptile(Animal):
    def __init__(self, birthType="born in egg or born alive", appearance="dry scales", blooded="cold blooded"):
        Animal.__init__(self, birthType, appearance, blooded)
